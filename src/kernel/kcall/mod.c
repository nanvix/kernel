             ...
             word_t kcall_nr)
{
    ...
    switch (kcall_nr) {
        ...
        case NR_do_mailbox_create:
            ret = kcall_do_mailbox_create((const pid_t)arg0, (const int)arg1);
            break;
        case NR_do_mailbox_open:
            ret = kcall_do_mailbox_open((const pid_t)arg0, (const int)arg1);
            break;
        case NR_do_mailbox_unlink:
            ret = kcall_do_mailbox_unlink((const int)arg0);
            break;
        case NR_do_mailbox_close:
            ret = kcall_do_mailbox_close((const int)arg0);
            break;
        case NR_do_mailbox_write:
            ret = kcall_do_mailbox_write(
                (const int)arg0, (const void *)arg1, (const size_t)arg2);
            break;
        case NR_do_mailbox_read:
            ret = kcall_do_mailbox_read(
