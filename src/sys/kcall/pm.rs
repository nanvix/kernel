...
pub fn getpid() -> Result<ProcessIdentifier, Error> {
    let result: i32 = unsafe { arch::kcall0(KcallNumber::GetPid.into()) };
...
pub fn gettid() -> Result<ThreadIdentifier, Error> {
    let result: i32 = unsafe { arch::kcall0(KcallNumber::GetTid.into()) };
...
pub fn getuid() -> Result<UserIdentifier, Error> {
    let result: i32 = unsafe { arch::kcall0(KcallNumber::GetUid.into()) };
...
pub fn geteuid() -> Result<UserIdentifier, Error> {
    let result: i32 = unsafe { arch::kcall0(KcallNumber::GetEuid.into()) };
    UserIdentifier::try_from(result)
}
...
pub fn getgid() -> Result<GroupIdentifier, Error> {
    let result: i32 = unsafe { arch::kcall0(KcallNumber::GetGid.into()) };
...
pub fn getegid() -> Result<GroupIdentifier, Error> {
    let result: i32 = unsafe { arch::kcall0(KcallNumber::GetEgid.into()) };
    GroupIdentifier::try_from(result)
}
...
pub fn exit(status: i32) -> Result<!, Error> {
    let result: i32 = unsafe { arch::kcall1(KcallNumber::Exit.into(), status as u32) };
...
pub fn capctl(capability: Capability, value: bool) -> Result<(), Error> {
    let result: i32 =
        unsafe { arch::kcall2(KcallNumber::CapCtl.into(), capability as u32, value as u32) };
...
pub fn terminate(pid: ProcessIdentifier) -> Result<(), Error> {
    let result: i32 =
        unsafe { arch::kcall1(KcallNumber::Terminate.into(), usize::from(pid) as u32) };
