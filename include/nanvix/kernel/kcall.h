...
#define NR_do_mailbox_create 25 /** Kcall_do_mailbox_create   */
#define NR_do_mailbox_open 26   /** kcall_do_mailbox_open     */
#define NR_do_mailbox_unlink 27 /** kcall_do_mailbox_unlink   */
#define NR_do_mailbox_close 28  /** kcall_do_mailbox_close    */
#define NR_do_mailbox_write 29  /** kcall_do_mailbox_write    */
#define NR_do_mailbox_read 30   /** kcall_do_mailbox_read     */
#define NR_last_kcall 31        /** NR_SYSCALLS definer       */
